...
namespace Flight.Data.Migrations
{
    ...
    [Migration("20220131110727_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flight.Flight.Models.Aircraft", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Flight.Flight.Models.Airport", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Flight.Flight.Models.Flight", b =>
                {
                    b.HasOne("Flight.Flight.Models.Aircraft", null)
                        .WithMany()
                        .HasForeignKey("AircraftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Flight.Flight.Models.Airport", null)
                        .WithMany()
